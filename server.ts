...
app.put("/api/spleads/:id", function(req , res){
    var query = "[dbo].[UpdateLeadInfo] @LeadID =" + req.params.id + ",@FirstName =  '" + req.body.FirstName + "' ,@LastName = '" + req.body.LastName + "',@Email = '" + req.body.Email+ "',@Phone = '" + req.body.Phone + "',@Mobile = '" + req.body.Phone + "',@Fax = N'654645',@Address = N'hg',@Address2 = NULL,	@City = N'N/A',@LanguageID =" + req.body.LanguageID + ",@CountryID = 96,@Gender = 1,@Birthdate = NULL,	@RankID = 1 " ;
    executeQuery (res, query);
});
// DELETE API
